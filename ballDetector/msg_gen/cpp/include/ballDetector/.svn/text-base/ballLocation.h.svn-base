/* Auto-generated by genmsg_cpp for file /home/leng/ros/projects/ballDetector/msg/ballLocation.msg */
...
struct ballLocation_ {
  ...
  typedef uint64_t _nSecond_type;
  uint64_t nSecond;
...
struct MD5Sum< ::ballDetector::ballLocation_<ContainerAllocator> > {
  ...
  {
    return "623e92adbd7c8e121151c5188ab75b02";
  }

  static const char* value(const  ::ballDetector::ballLocation_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x623e92adbd7c8e12ULL;
  static const uint64_t static_value2 = 0x1151c5188ab75b02ULL;
};
...
s << std::endl;
    ...
    s << indent << "nSecond: ";
    Printer<uint64_t>::stream(s, indent + "  ", v.nSecond);
  }
};
